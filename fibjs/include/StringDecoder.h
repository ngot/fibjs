...
typedef result_t (StringDecoder::*Text)(Buffer_base* buf, int32_t i, exlib::string& retVal);
...
private:
    ...
    result_t utf16Text(Buffer_base* buf, int32_t i, exlib::string& retVal);
    result_t base64Text(Buffer_base* buf, int32_t i, exlib::string& retVal);
    result_t utf8Text(Buffer_base* buf, int32_t i, exlib::string& retVal);
