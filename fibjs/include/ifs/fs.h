...
public:
    ...
    static result_t read(int32_t fd, Buffer_base* buffer, int32_t offset, int32_t length, int32_t position, AsyncEvent* ac);
...
public:
    ...
    ASYNC_STATIC5(fs_base, read, int32_t, Buffer_base*, int32_t, int32_t, int32_t);
