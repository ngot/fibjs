...
public:
    // StringDecoder_base
    static result_t _new(exlib::string data, obj_ptr<StringDecoder_base>& retVal, v8::Local<v8::Object> This = v8::Local<v8::Object>());
    ...
    virtual result_t text(Buffer_base* buf, int32_t i, exlib::string& retVal) = 0;
