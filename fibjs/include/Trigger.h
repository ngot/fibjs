...
public:
    ...
    result_t void _onceWrap(const v8::FunctionCallbackInfo<v8::Value>& args)
    {
        Isolate* isolate = Isolate::current();
        v8::Local<v8::Object> _data = v8::Local<v8::Object>::Cast(args.Data());

        v8::Local<v8::Function> func = _data->Get(NewFromUtf8("_func"))
        
        v8::Local<v8::Value> v = _data->Get(NewFromUtf8("_ev"));
        exlib::string ev;
        hr = GetArgumentValue(v, ev, true);
        if (hr < 0)
            return hr;
    ...
    {
        v8::Local<v8::Object> _data = v8::Object::New(isolate->m_isolate);
        _data->Set(isolate->NewFromUtf8("_func"), func->wrap());
    ...
    result_t prependOnceListener(exlib::string ev, v8::Local<v8::Function> func, v8::Local<v8::Object>& retVal)
    {
        ...
        // strKey.append(ev);
        // prependPutFunction(GetHiddenList(strKey, true), func);
